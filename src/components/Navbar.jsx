...
const Navbar = () => {
  return (
    ...
    <a href="https://www.linkedin.com/in/poorviraj-singh/" target="_blank" rel="noopener noreferrer">
    <FaLinkedin />
</a>
<a href="https://github.com/Poorviraj" target="_blank" rel="noopener noreferrer">
    <FaGithub />
</a>
